...
import { Typography, Space, Button, Col, Row, List, Avatar } from "antd";
        ...
        >
          <ProCard title={<Title level={5}>介绍</Title>} colSpan="50%">
              <Space direction="vertical">
                ...
                <Row gutter={8}>
                  <Col>
                    <img src="https://img.shields.io/github/stars/mortise-and-tenon/RuoYi-React-Pro?color=%2321BAB5&label=Stars&logo=github" />
                  </Col>
                  <Col>
                    <img src="https://img.shields.io/github/forks/mortise-and-tenon/RuoYi-React-Pro?color=%2321BAB5&label=Forks&logo=github" />
                  </Col>
                </Row>
                <Text>目前项目采用协议 Apache-2.0，可自由使用本项目。项目在 GitHub 和 Gitee 都有仓库。</Text>
                <Row gutter={16}>
                  <Col>
                    <Button
                      type="dashed"
